...
echo "This will force a reinstall of the gitbash shell itself."
echo "Once it completes, kill the shell and open another one."
...
pacman --overwrite '*' -Syu zip rsync
pacman --overwrite '*' -Syu tree pass
